...
_git clone_ - локальная копия удаленного репозитория

_git pull_ - скачать данные с удаленного репозитория

_git push_ - отправить данные в удаленный репозиторий
